...
from users.views import LogInView,RegisterView,IndexView,WelcomeView,LogOutView,ChooseCharView, InitateFightView
...
urlpatterns = patterns('',
    ...
    url(r'^fight/', InitateFightView.as_view(), name='fight' ),
)
